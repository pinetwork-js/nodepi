 ...
 */
export class CreatePassiveSellOfferOperation extends Operation<
...
> {
	...
	public constructor(client: Client, data: ServerApi.PassiveOfferOperationRecord) {
		super(client, data);

		this.$patch(data);
	}

	public $patch(data: ServerApi.PassiveOfferOperationRecord): void {
		super.$patch(data);
