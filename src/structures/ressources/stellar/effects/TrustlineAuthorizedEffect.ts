 ...
 */
export class TrustlineAuthorizedEffect extends Effect<
	EffectTypeNames.trustlineAuthorized,
...
> {
	...
	public constructor(client: Client, data: TrustlineAuthorized) {
		super(client, data);

		this.$patch(data);
	}

	public $patch(data: TrustlineAuthorized): void {
		super.$patch(data);
