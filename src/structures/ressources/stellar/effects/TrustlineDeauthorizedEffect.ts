import { EffectType, TrustlineDeauthorized } from 'stellar-sdk/lib/types/effects';
 ...
 */
export class TrustlineDeauthorizedEffect extends Effect<
	EffectTypeNames.trustlineDeauthorized,
...
> {
	...
	public constructor(client: Client, data: TrustlineDeauthorized) {
		super(client, data);

		this.$patch(data);
	}

	public $patch(data: TrustlineDeauthorized): void {
		super.$patch(data);
